...
כשהפונקציות הנתונות יכולות להיות גם פונקציות שאינן ניתנות לייצוג בכתיב מתמטי.</p>
  ...
  Crossover - 0.15<br>
   ...
   EvaluatorMetaData – מחזיק את הפונקציות הרנדומיות שאנחנו מגרילים, את הקבוע c, את הגבולות שבהם נרצה לבחון את המשתנים שלנו ורביעיית הפרמטרים – אוכלוסיה, דורות, crossover וה-mutation שבחרנו. בנוסף, מחזיק מידע כגון האם המשתמש רוצה סטטיסטיקות, וסט של פרמטרים לבדיקה עבור סטטיסטיקות.<br>
   Analytics – מייצר קובץ output שמפרט את ה-Fitness עבור כל אחד מהדורות, מציג את גרף ההתכנסות עבור הערכים שניתנו ומוצא את הערך המינמלי שעומד בתנאים בדרך ישירה. יוצג רק כאשר המשתמש בוחר לראות סטטיסטיקות.<br>
   FitnessEvaluator -חישוב ה-fitness לפי הפונקציה שתוארה מעלה.</p>
   </div>
